<div class="section page-banner-section" style="background-image: url(<?php echo !empty($atts['itsa_contact_bg__background'] ) ? wp_get_attachment_url($atts['itsa_contact_bg__background'])  : '' ?>);">
    <div class="shape-1">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="page-banner text-center">
                        <h2 class="title"><?php echo !empty($atts['itsa_contact_bg__title'] ) ? $atts['itsa_contact_bg__title']  : '' ?></h2>
                        <ul class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a href="<?php echo home_url() ?>">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page"><?php echo !empty($atts['itsa_contact_bg__title'] ) ? $atts['itsa_contact_bg__title']  : '' ?></li>
                        </ul>
                    </div>
