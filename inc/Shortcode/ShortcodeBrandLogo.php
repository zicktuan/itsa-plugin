<?php
    ...
    class ShortcodeBrandLogo extends AbstractShortcode
    {
        ...
        public function render($atts) {
            ...
            ob_start();
            include $this->parent->locateTemplate('shortcode-brand-logo.tpl.php');
            return ob_get_clean();
        }
        ...
        public function map() {
            ...
            return array(
                'name'        => esc_html__('Brand Logo', 'bookawesome'),
                'description' => esc_html__('Brand', 'bookawesome'),
