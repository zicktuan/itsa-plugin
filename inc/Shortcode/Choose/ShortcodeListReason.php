<?php
    ...
    class ShortcodeListReason extends AbstractShortcode
    {
        ...
        public function render($atts) {
            ...
            ob_start();
            include $this->parent->locateTemplate('choose/shortcode-list-reason.tpl.php');
            return ob_get_clean();
        }
        ...
        public function map() {
            $params = array(
                array(
                    'type'       => 'textfield',
                    'param_name' => 'itsa_choose_reason__sub_title',
                    'heading'    => esc_html__('Sub title', 'bookawesome')
                ),
                array(
                    'type'       => 'textfield',
                    'param_name' => 'itsa_choose_reason__title',
            ...
            return array(
                'name'        => esc_html__('Reason choose', 'bookawesome'),
