<?php
    ...
    class ShortcodeCouter extends AbstractShortcode
    {
        ...
        public function render($atts) {
            ...
            ob_start();
            include $this->parent->locateTemplate('home/shortcode-couter.tpl.php');
            return ob_get_clean();
        }
        ...
        public function map() {
            $params = array(
                array(
                    'type'       => 'attach_image',
                    'param_name' => 'itsa_home_counter__bg',
            ...
            return array(
                'name'        => esc_html__('Couter Home', 'bookawesome'),
